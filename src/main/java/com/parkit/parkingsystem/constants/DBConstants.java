...
public class DBConstants {
    ...
    public static final String GET_LAST_TICKET = "select t.ID, t.VEHICLE_REG_NUMBER FROM ticket t WHERE t.VEHICLE_REG_NUMBER = ? AND t.OUT_TIME <> NULL ORDER BY t.ID DESC LIMIT 1";
}
