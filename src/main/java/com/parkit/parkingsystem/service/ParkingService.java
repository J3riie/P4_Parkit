...
public class ParkingService {
	...
	public boolean isRecurringUser(String vehicleRegNumber) throws SQLException {
		return ticketDAO.findTicketByVehicleRegNumberAndOutTimeIsNotNull(vehicleRegNumber);
